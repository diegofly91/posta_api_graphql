...
export class TimeService extends BaseEntity {
    ...
    @ManyToOne(() => Timetable, timetable => timetable.timeservices,{nullable: false, cascade: true ,onDelete : "CASCADE"  } )
    ...
    @ManyToOne(() => Service, service => service.timeservices, {nullable: false, onDelete : "CASCADE" })
