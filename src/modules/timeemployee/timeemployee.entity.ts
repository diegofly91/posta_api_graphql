...
export class TimeEmployee extends BaseEntity {
    ...
    @ManyToOne(() => Timetable, timetable => timetable.timeemployees,{nullable: false, cascade: true ,onDelete : "CASCADE"  } )
    ...
    @ManyToOne(() => Employee, employee => employee.timeemployees, {nullable: false, onDelete : "CASCADE" })
