...
export class uniendotablauserconbcompany1601993620425 implements MigrationInterface {
    name = 'uniendotablauserconbcompany1601993620425'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `companies` (`id` int NOT NULL AUTO_INCREMENT, `users_id` int NOT NULL, `categories_id` int NOT NULL, `name` varchar(50) NOT NULL, `description` varchar(150) NULL, `address` varchar(100) NULL, `mobile` varchar(20) NULL, `status` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `update_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX `REL_42fb5216b69a8ed84b263590fb` (`users_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `users` ADD CONSTRAINT `FK_1d8dd7ffa37c3ab0c4eefb0b221` FOREIGN KEY (`roles_id`) REFERENCES `roles`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `companies` ADD CONSTRAINT `FK_42fb5216b69a8ed84b263590fbb` FOREIGN KEY (`users_id`) REFERENCES `users`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `companies` DROP FOREIGN KEY `FK_42fb5216b69a8ed84b263590fbb`");
        ...
        await queryRunner.query("DROP INDEX `REL_42fb5216b69a8ed84b263590fb` ON `companies`");
